...
def convert_ipv6_to_ipv4(ipv6_address):
    # Extract the last 32 bits of the IPv6 address
    ipv4_address = int(ipv6_address.split(':')[-1], 16)

    # Convert the last 32 bits to an IPv4 address string
    return f'{ipv4_address >> 24}.{(ipv4_address >> 16) & 255}.{(ipv4_address >> 8) & 255}.{ipv4_address & 255}'

ipv6_address = '2002:cb0a:3cdd:1::1'
ipv4_address = convert_ipv6_to_ipv4(ipv6_address)
print(ipv4_address)
# Output: '192.202.60.221'
